...
import 'package:chessground_game_app/features/computer_game/computer_game_setup_binding.dart';
import 'package:chessground_game_app/features/offline_game/offline_game_setup_binding.dart';
...
abstract class AppRoutes {
  ...
  static String offlineGameSetup = '/offlineGameSetup';
  static String computerGameSetup = '/computerGameSetup';
  ...
  static const String computerGame = '/computer-game';
  static const String puzzlePlay = '/puzzle-play';
}
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: AppRoutes.offlineGameSetup,
      page: () => const OfflineGameSetupPage(),
      binding: OfflineGameSetupBinding(),
    ),
    ...
    GetPage(
      name: AppRoutes.computerGameSetup,
      page: () => const ComputerGameSetupPage(),
      binding: ComputerGameSetupBinding(),
    ),
  ];
}