...
class AppPages {
  static final routes = [
    ...
    GetPage(name: RouteNames.gameComputerPage, page: () => GameComputerPage()),
    GetPage(name: RouteNames.gameComputerWithTimePage, page: () => GameComputerWithTimePage()),
    ...
    GetPage(name: RouteNames.freeGamePage, page: () => FreeGamePage()),
