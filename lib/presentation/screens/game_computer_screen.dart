...
class GameComputerScreen extends StatefulWidget {
  const GameComputerScreen({super.key, required this.title});

  final String title;

  @override
  State<GameComputerScreen> createState() => _GameComputerScreenState();
}

class _GameComputerScreenState extends State<GameComputerScreen> {
