...
class Evaluation {
  ...
  int evaluatePosition(Position pos) {
    // Hashing سريع
  ...
  (int op, int eg, int phase) _evaluateTapered(Position pos) {
  ...
  // ---------------- mobility ----------------
  ({int op, int eg}) _mobility(Position pos) {
  ...
  int _countMoves(Position pos, Side side) {
  ...
  // ---------------- king safety ----------------
  ({int op, int eg}) _kingSafety(Position pos) {
    final b = pos.board;
  ...
  // ---------------- pawn structure ----------------
  ({int op, int eg}) _pawnStructure(Position pos) {
    final b = pos.board;
    int score = 0;
  ...
  // ---------------- bishop pair ----------------
  ({int op, int eg}) _bishopPair(Position pos) {
    final b = pos.board;
    int score = 0;
    for (final side in [Side.white, Side.black]) {
  ...
  // ---------------- rooks & open files ----------------
  ({int op, int eg}) _rooksOpenFiles(Position pos) {
    final b = pos.board;
    int score = 0;
    for (final side in [Side.white, Side.black]) {
      final sign = side == Side.white ? 1 : -1;
  ...
  // ---------------- center control ----------------
  ({int op, int eg}) _centerControl(Position pos) {
    final b = pos.board;
  ...
  // ---------------- threats & attacks ----------------
  ({int op, int eg}) _threatsAndAttacks(Position pos) {
    final b = pos.board;
    int score = 0;
  ...
  // ---------------- king tropism ----------------
  ({int op, int eg}) _kingTropism(Position pos) {
    final b = pos.board;
    int score = 0;
  ...
  // ---------------- space advantage ----------------
  ({int op, int eg}) _spaceAdvantage(Position pos) {
    final b = pos.board;
