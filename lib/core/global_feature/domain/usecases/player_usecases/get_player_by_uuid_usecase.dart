...
class GetPlayerByUuidUseCase implements UseCase<PlayerEntity, GetPlayerByUuidParams> {
  final PlayerRepository repository;

  GetPlayerByUuidUseCase(this.repository);

  @override
  Future<Either<Failure, PlayerEntity>> call(GetPlayerByUuidParams params) async {
    try {
      AppLogger.info('Fetching player: ${params.uuid}', tag: 'GetPlayerByUuidUseCase');
      ...
      return Left(DatabaseFailure(message: 'Failed to fetch player: ${e.toString()}'));
    }
  }
}
