...
abstract class MoveDataModel with _$MoveDataModel {
  const factory MoveDataModel({
    ...
    @Default([]) final List<int> nags, // يجب جعلها غير اختيارية مع قيمة افتراضية لـ JSON
    final String? fenAfter,
    @Default([]) final List<String> variations, // يجب جعلها غير اختيارية مع قيمة افتراضية
  ...
  factory MoveDataModel.fromJson(Map<String, dynamic> json) => _$MoveDataModelFromJson(json);
}
