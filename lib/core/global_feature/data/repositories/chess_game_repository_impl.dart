...
class ChessGameRepositoryImpl implements ChessGameRepository {
  ...
  @override
  Future<Either<Failure, ChessGameEntity>> saveGame(ChessGameEntity game) async {
    try {
      AppLogger.info('Repository: Saving game ${game.uuid}', tag: 'ChessGameRepository');
      ...
      AppLogger.info('Repository: Game saved successfully', tag: 'ChessGameRepository');
      ...
      return Left(DatabaseFailure(message: 'Failed to save game: ${e.toString()}', details: e));
    }
  }

  @override
  Future<Either<Failure, ChessGameEntity>> updateGame(ChessGameEntity game) async {
    try {
      AppLogger.info('Repository: Updating game ${game.uuid}', tag: 'ChessGameRepository');
      ...
      AppLogger.info('Repository: Game updated successfully', tag: 'ChessGameRepository');
      ...
      return Left(DatabaseFailure(message: 'Failed to update game: ${e.toString()}', details: e));
    }
  }
  ...
  Future<Either<Failure, ChessGameEntity>> getGameByUuid(String uuid) async {
    try {
      AppLogger.info('Repository: Fetching game $uuid', tag: 'ChessGameRepository');
      ...
      AppLogger.info('Repository: Game fetched successfully', tag: 'ChessGameRepository');
      ...
      if (e.toString().contains('not found')) {
        return Left(NotFoundFailure(message: 'Game not found with UUID: $uuid'));
      }

      return Left(DatabaseFailure(message: 'Failed to fetch game: ${e.toString()}', details: e));
    }
  }
  ...
  Future<Either<Failure, ChessGameEntity>> getGameById(int id) async {
    try {
      AppLogger.info('Repository: Fetching game by ID $id', tag: 'ChessGameRepository');
  ...
  Future<Either<Failure, List<ChessGameEntity>>> getAllGames() async {
    try {
      AppLogger.info('Repository: Fetching all games', tag: 'ChessGameRepository');

      final models = await localDataSource.getAllGames();
      final entities = models.map((m) => m.toEntity()).toList();

      AppLogger.info('Repository: Fetched ${entities.length} games', tag: 'ChessGameRepository');
      ...
      return Left(DatabaseFailure(message: 'Failed to fetch games: ${e.toString()}', details: e));
    }
  }

  @override
  Future<Either<Failure, List<ChessGameEntity>>> getGamesByPlayer(String playerUuid) async {
    try {
      AppLogger.info(
      ...
      return Left(
        DatabaseFailure(message: 'Failed to fetch games for player: ${e.toString()}', details: e),
      );
    }
  }

  @override
  Future<Either<Failure, List<ChessGameEntity>>> getRecentGames({int limit = 20}) async {
    try {
      AppLogger.info(
      ...
      return Left(
        DatabaseFailure(message: 'Failed to fetch recent games: ${e.toString()}', details: e),
      );
    }
  }
  ...
  Future<Either<Failure, List<ChessGameEntity>>> getOngoingGames() async {
    try {
      AppLogger.info('Repository: Fetching ongoing games', tag: 'ChessGameRepository');
      ...
      return Left(
        DatabaseFailure(message: 'Failed to fetch ongoing games: ${e.toString()}', details: e),
      );
    }
  }
  ...
  Future<Either<Failure, List<ChessGameEntity>>> getCompletedGames() async {
    try {
      AppLogger.info('Repository: Fetching completed games', tag: 'ChessGameRepository');
      ...
      return Left(
        DatabaseFailure(message: 'Failed to fetch completed games: ${e.toString()}', details: e),
      );
    }
  }
  ...
  Future<Either<Failure, bool>> deleteGame(String uuid) async {
    try {
      AppLogger.info('Repository: Deleting game $uuid', tag: 'ChessGameRepository');
      ...
      return Left(DatabaseFailure(message: 'Failed to delete game: ${e.toString()}', details: e));
    }
  }
  ...
  Future<Either<Failure, bool>> deleteAllGames() async {
    try {
      AppLogger.info('Repository: Deleting all games', tag: 'ChessGameRepository');

      final result = await localDataSource.deleteAllGames();

      AppLogger.info('Repository: All games deletion successful', tag: 'ChessGameRepository');
      ...
      return Left(
        DatabaseFailure(message: 'Failed to delete all games: ${e.toString()}', details: e),
      );
    }
  }
  ...
  Future<Either<Failure, List<ChessGameEntity>>> searchGames({
    ...
    try {
      AppLogger.info('Repository: Searching games with filters', tag: 'ChessGameRepository');
      ...
      AppLogger.info('Repository: Found ${entities.length} games', tag: 'ChessGameRepository');
      ...
      return Left(DatabaseFailure(message: 'Failed to search games: ${e.toString()}', details: e));
    }
  }
  ...
  Future<Either<Failure, int>> getGamesCount() async {
    try {
      ...
      AppLogger.info('Repository: Total games count: $count', tag: 'ChessGameRepository');
      ...
      return Left(
        DatabaseFailure(message: 'Failed to get games count: ${e.toString()}', details: e),
      );
    }
  }
  ...
  Stream<Either<Failure, ChessGameEntity>> watchGame(String uuid) async* {
    try {
      AppLogger.info('Repository: Watching game $uuid', tag: 'ChessGameRepository');
      ...
      yield* Stream.value(Left(DatabaseFailure(message: 'Failed to watch game: ${e.toString()}')));
    }
  }
  ...
  Stream<Either<Failure, List<ChessGameEntity>>> watchAllGames() async* {
    try {
      AppLogger.info('Repository: Watching all games', tag: 'ChessGameRepository');
      ...
      yield* Stream.value(Left(DatabaseFailure(message: 'Failed to watch games: ${e.toString()}')));
    }
  }
}
