...
import '../global_features/data/pgn_fixtures.dart';
  ...
  group('Pgn', () {
    ...
    test('parse comment', () {
      ...
      expect(
        ...
        const PgnComment(eval: PgnEvaluation.pawns(pawns: -0.42)),
      );
      ...
      expect(
        ...
        const PgnComment(clock: Duration(minutes: 2, seconds: 5)),
      );
      ...
      expect(
        ...
        const PgnComment(text: 'suffix', eval: PgnEvaluation.mate(mate: -3)),
      );
    ...
    test('make comment', () {
      ...
      expect(
        const PgnComment(
          eval: PgnEvaluation.mate(mate: -4, depth: 5),
        ).makeComment(),
        '[%eval #-4,5]',
      );
    });
    ...
    test('transform pgn', () {
      ...
      final PgnNode<PgnNodeWithFen> res = game.moves
          .transform<PgnNodeWithFen, Position>(
