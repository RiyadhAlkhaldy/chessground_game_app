    ...
    group('Mate Conditions', () {
      test('should correctly identify checkmate', () {
        ...
        expect(
          gameState.isMate,
          isTrue,
          reason: 'isMate should be true for checkmate',
        );
      ...
      test('should correctly identify back-rank checkmate', () {
        ...
        expect(
          ...
          isTrue,
          reason: 'Should be a back-rank checkmate',
        );
      ...
      test('should correctly handle resignation', () {
        ...
        expect(
          ...
          isTrue,
          reason: 'Game should be resigned',
        );
        expect(
          gameState.isMate,
          isTrue,
          reason: 'isMate should be true for resignation',
        );
        expect(
          gameState.result?.winner,
          equals(Side.black),
      ...
      test('should correctly handle timeout', () {
        ...
        expect(
          gameState.isTimeout(),
          isTrue,
          reason: 'Game should be over by timeout',
        );
        expect(
          gameState.isMate,
          isTrue,
          reason: 'isMate should be true for timeout',
        );
        expect(
          gameState.result?.winner,
          equals(Side.white),
    ...
    group('Draw Conditions', () {
      test('should correctly identify stalemate', () {
        ...
        expect(
          gameState.isDraw,
          isTrue,
          reason: 'isDraw should be true for stalemate',
        );
      ...
      test('should correctly identify draw by the fifty-move rule', () {
        ...
        expect(
          ...
          100,
          reason: 'Half-move clock should be 100',
        );
      ...
      test('should correctly identify draw by insufficient material', () {
        ...
        expect(
          gameState.isInsufficientMaterial,
          isTrue,
          reason: 'King+Knight vs King is a draw',
        );
